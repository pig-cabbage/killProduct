...
public class SeckillController {
    ...
    public ResultBean<String> doSeckill(@RequestParam("productId") long productId, @RequestParam("userId") int userId, @RequestParam("value") int value) {
        Logger log = Logger.getLogger("asdas");

        long a = System.currentTimeMillis();
        ResultBean resultBean = new ResultBean<>(seckillService.doSeckill(productId, userId, value));
